...
export default function CukierPage() {
  ...
  const productData = {
    ...
    color: "pink",
    dbCategory: "suchy",
    dbSubcategory: "cukier",
    description: "Cukier brązowy i biały",
  };
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            onClick={refreshData}
            disabled={loading}
            className="bg-pink-500 hover:bg-pink-600 disabled:bg-pink-300 text-white px-4 py-2 rounded-lg font-medium transition-colors cursor-pointer"
          >
            🔄 Odśwież
          </button>
        </div>
