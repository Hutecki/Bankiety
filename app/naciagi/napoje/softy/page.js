...
export default function SoftyPage() {
  ...
  const pobierzNaciagi = useCallback(async () => {
    try {
      ...
      if (response.ok) {
        ...
        const filteredData = data.filter((n) => n.podkategoria === "softy");
    ...
    try {
      ...
      if (response.ok) {
        ...
        const filteredTransactions = data.filter((t) =>
          naciagi.some(
            (n) => n.nazwa === t.nazwaNaciagu && t.podkategoria === "softy"
          )
        );
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-800">Softy</h1>
              ...
              {loading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    Brak produktów w kategorii Softy
                  </p>
                </div>
              ) : (
